...
<html>
	<head>
		...
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script> <!--google jquery/ jQuery-->
...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>
	...
	<body>
		...
		<script type="text/javascript" src="js/entities/PlayerBaseEntities.js"></script>
		...
		<script>
		$("#mainmenu").bind("click", function(){ // it uses # for mainmenu and went you click it goes back to mainmenu 
